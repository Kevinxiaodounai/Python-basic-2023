...
# 正课项目中发送邮件的代码
from new_homework.day9.code.tools.smtp_send_mail_attachment import qyt_smtp_attachment

# 正课项目中较文本的代码
from new_homework.day9.code.tools.diff_config import diff_txt
...
for device_config_raw, ip in result_list:
    ...
    if last_config_bak.config_md5 != md5_value:
