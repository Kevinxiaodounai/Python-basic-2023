...
# 设备接口信息
c8kv1_ifs = [{'ifname': "GigabitEthernet1", 'ip': "10.1.1.1", 'mask': "255.255.255.0"},
             {'ifname': "Loopback0", 'ip': "1.1.1.1", 'mask': "255.255.255.255"}]

c8kv2_ifs = [{'ifname': "GigabitEthernet1", 'ip': "10.1.1.2", 'mask': "255.255.255.0"},
             {'ifname': "Loopback0", 'ip': "2.2.2.2", 'mask': "255.255.255.255"}]

# 设备OSPF信息
c8kv1_ospf = {"process_id": 1,
              "router_id": "1.1.1.1",
              "areas": [{'area_id': 0, 'networks': [{'ip': "10.1.1.0", 'wildmask': "0.0.0.255"},
